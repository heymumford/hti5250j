...
/**
 * Testing the correctness of {@link CCSID1140} and comparing with existing implementation.
 *
 * @author master_jaf
 */
public class CCSID1140Test {
    ...
    public void testNewConverter1140() {
        CodepageConverterAdapter cp = CCSIDFactory.getConverter("1140");
        cp.init();
        assertNotNull(cp,"At least an ASCII Codepage should be available.");
    ...
    public void testBoth() {
        ...
        final CodepageConverterAdapter cpex = CCSIDFactory.getConverter("1140");
        cpex.init();
