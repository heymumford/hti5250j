 ...
 * Company:
 *
 * Description: Pairwise TDD test suite for TN5250j RA (Repeat to Address) command.
 *
...
/**
 * Pairwise parameter testing for TN5250j RA (Repeat to Address) command.
 *
 * Focus areas:
...
public class RACommandPairwiseTest {
    ...
    private static class RACommandTestHarness {
        ...
        public RACommandTestHarness(int rows, int cols) {
            ...
            this.currentRow = 1;  // 1-based in TN5250j
         ...
         * Simulates org.tn5250j.framework.tn5250.tnvt.processRepeatToAddress()
         *
