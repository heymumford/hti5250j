 ...
 * TN5250j plugin/extension architecture by combining multiple test dimensions:
 *
 * Pairwise Dimensions:
...
public class PluginExtensionPairwiseTest {
    ...
    public void testLoadScreenDecoratorPlugin() throws PluginException {
        ...
        TN5250jPlugin loaded = pluginManager.loadPlugin(SimpleScreenDecorator.class);

        assertNotNull(loaded);
        assertEquals("org.tn5250j.plugin.screen-decorator-test", loaded.getPluginId());
    ...
    public void testLoadKeyHandlerPlugin() throws PluginException {
        ...
        TN5250jPlugin loaded = pluginManager.loadPlugin(SimpleKeyHandler.class);

        assertNotNull(loaded);
        assertEquals("org.tn5250j.plugin.key-handler-test", loaded.getPluginId());
        assertEquals(PluginVersion.CURRENT, loaded.getVersion());
        assertFalse(loaded.isActive());
    }
    ...
    public void testLoadProtocolFilterPlugin() throws PluginException {
        ...
        TN5250jPlugin loaded = pluginManager.loadPlugin(SimpleProtocolFilter.class);

        assertNotNull(loaded);
        assertEquals("org.tn5250j.plugin.protocol-filter-test", loaded.getPluginId());
        assertEquals(PluginVersion.CURRENT, loaded.getVersion());
        assertFalse(loaded.isActive());
    }
    ...
    public void testCompleteLifecycleFlow() throws PluginException {
        TN5250jPlugin plugin = pluginManager.loadPlugin(SimpleScreenDecorator.class);

        // After load: plugin exists but not active
        assertFalse(plugin.isActive());
        assertTrue(lifecycleEvents.contains("LOADED:org.tn5250j.plugin.screen-decorator-test"));

        // Activate
        pluginManager.activatePlugin(plugin.getPluginId());
        assertTrue(plugin.isActive());
        assertTrue(lifecycleEvents.contains("ACTIVATED:org.tn5250j.plugin.screen-decorator-test"));

        // Deactivate
        pluginManager.deactivatePlugin(plugin.getPluginId());
        assertFalse(plugin.isActive());
        assertTrue(lifecycleEvents.contains("DEACTIVATED:org.tn5250j.plugin.screen-decorator-test"));

        // Unload
        pluginManager.unloadPlugin(plugin.getPluginId());
        assertNull(pluginManager.getPlugin(plugin.getPluginId()));
        assertTrue(lifecycleEvents.contains("UNLOADED:org.tn5250j.plugin.screen-decorator-test"));
    }
    ...
    public void testActivatePluginAfterLoad() throws PluginException {
        TN5250jPlugin plugin = pluginManager.loadPlugin(SimpleKeyHandler.class);
        assertFalse(plugin.isActive());
    ...
    public void testDeactivatePlugin() throws PluginException {
        TN5250jPlugin plugin = pluginManager.loadPlugin(SimpleProtocolFilter.class);
        pluginManager.activatePlugin(plugin.getPluginId());
        assertTrue(plugin.isActive());
    ...
    public void testChainedDependencies() throws PluginException {
        ...
        TN5250jPlugin depPlugin = pluginManager.loadPlugin(SimpleProtocolFilter.class);
        pluginManager.activatePlugin(depPlugin.getPluginId());

        // Load dependent plugin
        TN5250jPlugin depender = pluginManager.loadPlugin(DependentKeyHandler.class);
    ...
    public void testCircularDependenciesRejected() throws PluginException {
        ...
        try {
            pluginManager.activatePlugin("org.tn5250j.plugin.circular-a");
            // If we get here, trying to activate B should fail due to circular dep
            pluginManager.activatePlugin("org.tn5250j.plugin.circular-b");
    ...
    public void testConflictingDependenciesRejected() throws PluginException {
        TN5250jPlugin conflict1 = pluginManager.loadPlugin(ConflictPluginA.class);
        ...
        TN5250jPlugin conflict2 = pluginManager.loadPlugin(ConflictPluginB.class);
    ...
    public void testGracefulActivateError() throws PluginException {
        TN5250jPlugin plugin = pluginManager.loadPlugin(BrokenActivatePlugin.class);
    ...
    public void testCrashingPluginHandledGracefully() throws PluginException {
        TN5250jPlugin plugin = pluginManager.loadPlugin(CrashingActivatePlugin.class);
        ...
        TN5250jPlugin normalPlugin = pluginManager.loadPlugin(SimpleKeyHandler.class);
    ...
    public void testPluginWithSlowDeactivation() throws PluginException {
        TN5250jPlugin plugin = pluginManager.loadPlugin(QuickDeactivatePlugin.class);
        pluginManager.activatePlugin(plugin.getPluginId());
    ...
    public void testMultiplePluginsLoaded() throws PluginException {
        TN5250jPlugin decorator = pluginManager.loadPlugin(SimpleScreenDecorator.class);
        TN5250jPlugin handler = pluginManager.loadPlugin(SimpleKeyHandler.class);
        TN5250jPlugin filter = pluginManager.loadPlugin(SimpleProtocolFilter.class);

        List<TN5250jPlugin> all = pluginManager.getAllPlugins();
    ...
    public void testEmptyPluginList() {
        List<TN5250jPlugin> plugins = pluginManager.getAllPlugins();
    ...
    public static class SimpleScreenDecorator extends BaseTestPlugin implements ScreenDecoratorPlugin {
        public SimpleScreenDecorator() {
            super("org.tn5250j.plugin.screen-decorator-test", "Test Screen Decorator", PluginVersion.CURRENT);
        }
    ...
    public static class SimpleKeyHandler extends BaseTestPlugin implements KeyHandlerPlugin {
        public SimpleKeyHandler() {
            super("org.tn5250j.plugin.key-handler-test", "Test Key Handler", PluginVersion.CURRENT);
        }
    ...
    public static class SimpleProtocolFilter extends BaseTestPlugin implements ProtocolFilterPlugin {
        public SimpleProtocolFilter() {
            super("org.tn5250j.plugin.protocol-filter-test", "Test Protocol Filter", PluginVersion.CURRENT);
        }
    ...
    public static class LegacyKeyHandler extends BaseTestPlugin implements KeyHandlerPlugin {
        public LegacyKeyHandler() {
            super("org.tn5250j.plugin.legacy-key-handler", "Legacy Key Handler", PluginVersion.LEGACY);
        }
    ...
    public static class FutureProtocolFilter extends BaseTestPlugin implements ProtocolFilterPlugin {
        public FutureProtocolFilter() {
            super("org.tn5250j.plugin.future-filter", "Future Protocol Filter", PluginVersion.FUTURE);
        }
    ...
    public static class DependentKeyHandler extends BaseTestPlugin implements KeyHandlerPlugin {
        public DependentKeyHandler() {
            super("org.tn5250j.plugin.dependent-handler", "Dependent Handler", PluginVersion.CURRENT,
                    "org.tn5250j.plugin.protocol-filter-test");
        }
    ...
    public static class CircularPluginA extends BaseTestPlugin implements ScreenDecoratorPlugin {
        public CircularPluginA() {
            super("org.tn5250j.plugin.circular-a", "Circular A", PluginVersion.CURRENT,
                    "org.tn5250j.plugin.circular-b");
        }
    ...
    public static class CircularPluginB extends BaseTestPlugin implements KeyHandlerPlugin {
        public CircularPluginB() {
            super("org.tn5250j.plugin.circular-b", "Circular B", PluginVersion.CURRENT,
                    "org.tn5250j.plugin.circular-a");
        }
    ...
    public static class ConflictPluginA extends BaseTestPlugin implements ScreenDecoratorPlugin {
        public ConflictPluginA() {
            super("org.tn5250j.plugin.conflict-a", "Conflict A", PluginVersion.CURRENT);
        }
    ...
    public static class ConflictPluginB extends BaseTestPlugin implements ScreenDecoratorPlugin {
        public ConflictPluginB() {
            super("org.tn5250j.plugin.conflict-b", "Conflict B", PluginVersion.CURRENT);
        }
    ...
    public static class BrokenLoadPlugin extends BaseTestPlugin implements KeyHandlerPlugin {
        public BrokenLoadPlugin() {
            super("org.tn5250j.plugin.broken-load", "Broken Load", PluginVersion.CURRENT);
        }
    ...
    public static class BrokenActivatePlugin extends BaseTestPlugin implements ProtocolFilterPlugin {
        public BrokenActivatePlugin() {
            super("org.tn5250j.plugin.broken-activate", "Broken Activate", PluginVersion.CURRENT);
        }
    ...
    public static class MaliciousPlugin extends BaseTestPlugin implements ScreenDecoratorPlugin {
        public MaliciousPlugin() {
            super("org.tn5250j.plugin.malicious", "Malicious", PluginVersion.CURRENT);
        }
    ...
    public static class CrashingActivatePlugin extends BaseTestPlugin implements KeyHandlerPlugin {
        public CrashingActivatePlugin() {
            super("org.tn5250j.plugin.crashing-activate", "Crashing Activate", PluginVersion.CURRENT);
        }
    ...
    public static class QuickDeactivatePlugin extends BaseTestPlugin implements ProtocolFilterPlugin {
        public QuickDeactivatePlugin() {
            super("org.tn5250j.plugin.quick-deactivate", "Quick Deactivate", PluginVersion.CURRENT);
        }
    ...
    public static class BaseTestPlugin implements TN5250jPlugin {
    ...
    public static class TestPluginManager implements PluginManager {
        private Map<String, TN5250jPlugin> plugins = new HashMap<>();
        private List<PluginLifecycleListener> listeners = new ArrayList<>();

        @Override
        public TN5250jPlugin loadPlugin(Class<? extends TN5250jPlugin> pluginClass)
                throws PluginException {
            try {
                TN5250jPlugin plugin = pluginClass.getDeclaredConstructor().newInstance();
        ...
        public void unloadPlugin(String pluginId) throws PluginException {
            TN5250jPlugin plugin = plugins.get(pluginId);
            if (plugin != null) {
                if (plugin.isActive()) {
        ...
        public void activatePlugin(String pluginId) throws PluginException {
            ...
            for (String depId : plugin.getDependencies()) {
                ...
                TN5250jPlugin dep = plugins.get(depId);
                if (!dep.isActive()) {
        ...
        @Override
        public TN5250jPlugin getPlugin(String pluginId) {
            return plugins.get(pluginId);
        }

        @Override
        public List<TN5250jPlugin> getAllPlugins() {
            return new ArrayList<>(plugins.values());
        }

        @Override
        public <T extends TN5250jPlugin> List<T> getPluginsOfType(Class<T> interfaceClass) {
            List<T> result = new ArrayList<>();
            for (TN5250jPlugin plugin : plugins.values()) {
