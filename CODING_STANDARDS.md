...
| Audience | All contributors (with extra clarity for entry-level Java engineers) |
| Language | Java 21 (Temurin 21, cross-platform POSIX) |

## Style and Comments

Code should be readable to an entry-level Java engineer without external docs. Code shows what and how; comments explain why.
...
- One primary reason to change per class or file.
- Methods <= 50 lines, prefer <= 30 lines.
- Names reflect intent; avoid abbreviations.
- Assumptions documented and testable.
- Behavior covered by at least one test at the appropriate domain.
