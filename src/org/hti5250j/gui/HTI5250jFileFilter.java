...
//   private String HIDDEN_FILE = "Hidden File";
     ...
     * @see #addExtension
     */
    public HTI5250jFileFilter() {
        this.filters = new Hashtable(5);
    }

    /**
     * Creates a file filter that accepts files with the given extension.
     * Example: new HTI5250jFileFilter("jpg");
     *
     * @see #addExtension
     */
    public HTI5250jFileFilter(String extension) {
        this(extension, null);
    }

    /**
     * Creates a file filter that accepts the given file type.
     * Example: new HTI5250jFileFilter("jpg", "JPEG Image Images");
     *
     ...
     * Example: new HTI5250jFileFilter(String {"gif", "jpg"});
     *
     ...
     * @see #addExtension
     */
    public HTI5250jFileFilter(String[] filters) {
        this(filters, null);
    }

    /**
     * Creates a file filter from the given string array and description.
     * Example: new HTI5250jFileFilter(String {"gif", "jpg"}, "Gif and JPG Images");
     *
