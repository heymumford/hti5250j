...
import org.hti5250j.connectdialog.ConnectDialog;
import org.hti5250j.event.BootEvent;
import org.hti5250j.event.BootListener;
...
public class My5250 implements BootListener, SessionListener, EmulatorActionListener {
    ...
    private HTI5250jSplashScreen splash;
    private int step;
    ...
    My5250() {
        ...
        splash = new HTI5250jSplashScreen("tn5250jSplash.jpg");
        splash.setSteps(5);
...
//		startFrameType();
    ...
    public void bootOptionsReceived(BootEvent bootEvent) {
        ...
        if (!bootEvent.getNewSessionOptions().equals("null")) {
            ...
            String[] args = new String[HTI5250jConstants.NUM_PARMS];
    ...
    private synchronized void newSession(String sel, String[] args) {
        ...
        if (isSpecified("-usp", args)) {
            ...
            if (isSpecified("-sph", args)) {
                sesProps.put(HTI5250jConstants.SESSION_PROXY_HOST, getParm("-sph", args));
            }
        ...
        if (isSpecified("-sslType", args)) {
            ...
            sesProps.put(HTI5250jConstants.SSL_TYPE, getParm("-sslType", args));
        }
        ...
        if (isSpecified("-dn=hostname", args)) {
            ...
            sesProps.put(HTI5250jConstants.SESSION_DEVICE_NAME, dnParam);
    ...
    private void initScripting() {
        ...
        try {
            Class.forName("org.hti5250j.scripting.JPythonInterpreterDriver");
