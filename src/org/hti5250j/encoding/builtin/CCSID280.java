...
/**
 * EBCDIC CECP: Italy (CCSID 280) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("280") directly.
...
public final class CCSID280 extends CodepageConverterAdapter {
    ...
    public static final String DESCR = "CECP: Italy";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID280 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID280() {
        this.delegate = CCSIDFactory.getConverter("280");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID280 mappings not found in factory");
        }
    }
