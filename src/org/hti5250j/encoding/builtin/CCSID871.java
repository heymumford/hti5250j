...
/**
 * EBCDIC CECP: Iceland (CCSID 871) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("871") directly.
 * This wrapper will be removed in a future release.
 */
@Deprecated(since = "Phase 3", forRemoval = true)
public final class CCSID871 extends CodepageConverterAdapter {

    public static final String NAME = "871";
    public static final String DESCR = "CECP: Iceland";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID871 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID871() {
        this.delegate = CCSIDFactory.getConverter("871");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID871 mappings not found in factory");
        }
    }
