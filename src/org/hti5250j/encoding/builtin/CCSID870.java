...
/**
 * EBCDIC CECP: Latin-2 (CCSID 870) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("870") directly.
 * This wrapper will be removed in a future release.
 */
@Deprecated(since = "Phase 3", forRemoval = true)
public final class CCSID870 extends CodepageConverterAdapter {

    public static final String NAME = "870";
    public static final String DESCR = "CECP: Latin-2";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID870 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID870() {
        this.delegate = CCSIDFactory.getConverter("870");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID870 mappings not found in factory");
        }
    }
