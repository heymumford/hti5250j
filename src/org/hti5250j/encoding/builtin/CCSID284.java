...
/**
 * EBCDIC CECP: Spain, Latin America (CCSID 284) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("284") directly.
 * This wrapper will be removed in a future release.
 */
@Deprecated(since = "Phase 3", forRemoval = true)
public final class CCSID284 extends CodepageConverterAdapter {

    public static final String NAME = "284";
    public static final String DESCR = "CECP: Spain, Latin America";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID284 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID284() {
        this.delegate = CCSIDFactory.getConverter("284");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID284 mappings not found in factory");
        }
    }
