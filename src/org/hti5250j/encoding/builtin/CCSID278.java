...
/**
 * EBCDIC CECP: Sweden, Finland (CCSID 278) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("278") directly.
 * This wrapper will be removed in a future release.
 */
@Deprecated(since = "Phase 3", forRemoval = true)
public final class CCSID278 extends CodepageConverterAdapter {

    public static final String NAME = "278";
    public static final String DESCR = "CECP: Sweden, Finland";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID278 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID278() {
        this.delegate = CCSIDFactory.getConverter("278");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID278 mappings not found in factory");
        }
    }
