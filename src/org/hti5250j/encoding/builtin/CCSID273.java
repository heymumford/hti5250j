...
/**
 * EBCDIC CECP: Germany, Austria (CCSID 273) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("273") directly.
 * This wrapper will be removed in a future release.
 */
@Deprecated(since = "Phase 3", forRemoval = true)
public final class CCSID273 extends CodepageConverterAdapter {

    public static final String NAME = "273";
    public static final String DESCR = "CECP: Germany, Austria";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID273 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID273() {
        this.delegate = CCSIDFactory.getConverter("273");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID273 mappings not found in factory");
        }
    }
