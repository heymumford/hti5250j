...
/**
 * EBCDIC CECP: Denmark, Norway (CCSID 277) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("277") directly.
 * This wrapper will be removed in a future release.
 */
@Deprecated(since = "Phase 3", forRemoval = true)
public final class CCSID277 extends CodepageConverterAdapter {

    public static final String NAME = "277";
    public static final String DESCR = "CECP: Denmark, Norway";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID277 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID277() {
        this.delegate = CCSIDFactory.getConverter("277");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID277 mappings not found in factory");
        }
    }
