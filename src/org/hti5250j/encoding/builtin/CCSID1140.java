...
/**
 * EBCDIC CECP: US (Euro) (CCSID 1140) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("1140") directly.
...
public final class CCSID1140 extends CodepageConverterAdapter {
    ...
    public final static String DESCR = "CECP: US (Euro)";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID1140 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID1140() {
        this.delegate = CCSIDFactory.getConverter("1140");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID1140 mappings not found in factory");
        }
    }
