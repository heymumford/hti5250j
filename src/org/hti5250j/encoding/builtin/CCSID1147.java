...
/**
 * EBCDIC CECP: France (Euro) (CCSID 1147) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("1147") directly.
 * This wrapper will be removed in a future release.
 */
@Deprecated(since = "Phase 3", forRemoval = true)
public final class CCSID1147 extends CodepageConverterAdapter {

    public static final String NAME = "1147";
    public static final String DESCR = "CECP: France (Euro)";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID1147 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID1147() {
        this.delegate = CCSIDFactory.getConverter("1147");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID1147 mappings not found in factory");
        }
    }
