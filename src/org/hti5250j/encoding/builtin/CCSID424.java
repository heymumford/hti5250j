...
/**
 * EBCDIC CECP: Hebrew (CCSID 424) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("424") directly.
...
public final class CCSID424 extends CodepageConverterAdapter {
    ...
    /**
     * Create a CCSID424 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID424() {
        this.delegate = CCSIDFactory.getConverter("424");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID424 mappings not found in factory");
        }
    }
