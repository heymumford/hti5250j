...
/**
 * EBCDIC CECP: Estonia (CCSID 1122) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("1122") directly.
 * This wrapper will be removed in a future release.
 */
@Deprecated(since = "Phase 3", forRemoval = true)
public final class CCSID1122 extends CodepageConverterAdapter {

    public final static String NAME = "1122";
    public final static String DESCR = "CECP: Estonia";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID1122 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID1122() {
        this.delegate = CCSIDFactory.getConverter("1122");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID1122 mappings not found in factory");
        }
    }
