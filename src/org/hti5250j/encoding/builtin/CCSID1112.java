...
/**
 * EBCDIC CECP: Baltic (CCSID 1112) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("1112") directly.
 * This wrapper will be removed in a future release.
 */
@Deprecated(since = "Phase 3", forRemoval = true)
public final class CCSID1112 extends CodepageConverterAdapter {

    public static final String NAME = "1112";
    public static final String DESCR = "CECP: Baltic";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID1112 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID1112() {
        this.delegate = CCSIDFactory.getConverter("1112");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID1112 mappings not found in factory");
        }
    }
