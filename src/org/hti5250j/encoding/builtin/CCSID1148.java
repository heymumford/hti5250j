...
/**
 * EBCDIC CECP: UK (Euro) (CCSID 1148) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("1148") directly.
 * This wrapper will be removed in a future release.
 */
@Deprecated(since = "Phase 3", forRemoval = true)
public final class CCSID1148 extends CodepageConverterAdapter {

    public static final String NAME = "1148";
    public static final String DESCR = "CECP: UK (Euro)";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID1148 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID1148() {
        this.delegate = CCSIDFactory.getConverter("1148");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID1148 mappings not found in factory");
        }
    }
