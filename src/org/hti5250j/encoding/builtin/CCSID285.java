...
/**
 * EBCDIC CECP: UK, Ireland (CCSID 285) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("285") directly.
...
public final class CCSID285 extends CodepageConverterAdapter {
    ...
    /**
     * Create a CCSID285 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID285() {
        this.delegate = CCSIDFactory.getConverter("285");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID285 mappings not found in factory");
        }
    }
