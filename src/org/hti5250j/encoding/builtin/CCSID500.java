...
/**
 * EBCDIC CECP: International (CCSID 500) character encoding.
 *
 ...
 * @author master_jaf
 *
 * @deprecated Use CCSIDFactory.getConverter("500") directly.
...
public final class CCSID500 extends CodepageConverterAdapter {
    ...
    public final static String DESCR = "CECP: International";

    private final CodepageConverterAdapter delegate;

    /**
     * Create a CCSID500 converter using the factory pattern.
     * Delegates to CCSIDFactory which loads mappings from JSON configuration.
     */
    public CCSID500() {
        this.delegate = CCSIDFactory.getConverter("500");
        if (this.delegate == null) {
            throw new RuntimeException("CCSID500 mappings not found in factory");
        }
    }
