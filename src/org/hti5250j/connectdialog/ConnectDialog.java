...
import org.hti5250j.gui.JSortTable;
...
import org.hti5250j.tools.DESSHA1;
...
public class ConnectDialog extends JDialog implements ActionListener, ChangeListener {
    ...
    private void createLoggingPanel() {
        ...
        switch (logLevel) {
            ...
            case HTI5250jLogger.DEBUG:
                ...
                break;
            case HTI5250jLogger.INFO:
                intINFO.setSelected(true);
                break;
            case HTI5250jLogger.WARN:
                intWARN.setSelected(true);
                break;
            case HTI5250jLogger.ERROR:
                intERROR.setSelected(true);
                break;
            case HTI5250jLogger.FATAL:
    ...
    private void createAboutPanel() {
        ...
        contenpane.add(new JLabel("HTI5250j"));
        contenpane.add(new JLabel("Version: " + HTI5250jConstants.VERSION_INFO));
        ...
        if (intOFF.isSelected()) {
            ...
            properties
                    .setProperty("emul.logLevel", Integer
                            .toString(HTI5250jLogger.OFF));
        }

        if (intDEBUG.isSelected()) {

            properties.setProperty("emul.logLevel", Integer
                    .toString(HTI5250jLogger.DEBUG));
        }

        if (intINFO.isSelected()) {

            properties.setProperty("emul.logLevel", Integer
                    .toString(HTI5250jLogger.INFO));
        }

        if (intWARN.isSelected()) {

            properties.setProperty("emul.logLevel", Integer
                    .toString(HTI5250jLogger.WARN));
        }

        if (intERROR.isSelected()) {

            properties.setProperty("emul.logLevel", Integer
                    .toString(HTI5250jLogger.ERROR));
        }

        if (intFATAL.isSelected()) {

            properties.setProperty("emul.logLevel", Integer
                    .toString(HTI5250jLogger.FATAL));
        }
    ...
    private void intOFF_itemStateChanged(ItemEvent e) {
        if (!intOFF.isSelected() && HTI5250jLogFactory.isLog4j()) {
            ...
            intFile.setEnabled(false);
            intBoth.setEnabled(false);
            HTI5250jLogFactory.setLogLevels(HTI5250jLogger.OFF);
        }
    }

    private void intDEBUG_itemStateChanged(ItemEvent e) {
        if (intDEBUG.isSelected()) {
            HTI5250jLogFactory.setLogLevels(HTI5250jLogger.DEBUG);
        }
    }

    private void intINFO_itemStateChanged(ItemEvent e) {
        if (intINFO.isSelected()) {
            HTI5250jLogFactory.setLogLevels(HTI5250jLogger.INFO);
        }
    }

    private void intWARN_itemStateChanged(ItemEvent e) {
        if (intWARN.isSelected()) {
            HTI5250jLogFactory.setLogLevels(HTI5250jLogger.WARN);
        }
    }

    private void intERROR_itemStateChanged(ItemEvent e) {
        if (intERROR.isSelected()) {
            HTI5250jLogFactory.setLogLevels(HTI5250jLogger.ERROR);
        }
    }
