/*
 * SPDX-FileCopyrightText: Copyright (c) 2001 Company
...
public final class tnvt implements Runnable {
    ...
    public final boolean disconnect() {
        ...
        try {
            ...
            controller.fireSessionChanged(HTI5250jConstants.STATE_DISCONNECTED);
        ...
        while (keepTrucking) {
            ...
            switch (bk.getOpCode()) {
                ...
                case 3:
                    ...
                    if (!firstScreen) {
                        firstScreen = true;
                        controller.fireSessionChanged(HTI5250jConstants.STATE_CONNECTED);
                    }
                    break;
                case 4:
    ...
    private byte[] createRegenerationBuffer(int len) throws IOException {
        ...
        try {
            ...
            log.warn("Error, while filling the screen array. HTI5250j will continue to operate, but screen may be displayed wrong.", e);
        }
        return sa;
    }
    ...
    /**
     * @see org.hti5250j.Session5250#signalBell()
     */
