...
import org.hti5250j.sql.AS400Xtfr;
import org.hti5250j.sql.SqlWizard;
import org.hti5250j.tools.filters.*;
...
//	}
    ...
    private void saveXTFRInfo() {
        ...
        // set the file filters for the file chooser
        HTI5250jFileFilter filter = new HTI5250jFileFilter("dtf", "Transfer from AS/400");
    ...
    class FFDTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int row, int col) {
            ...
            if (col == 0) {
                ...
                return Boolean.valueOf(ftpProtocol.isFieldSelected(row));
