...
/**
 * TN5250jPlugin - Core plugin interface defining lifecycle and metadata.
 *
 ...
 */
public interface TN5250jPlugin {

    /**
     * Get unique plugin identifier (e.g., "org.tn5250j.plugin.screen-decorator-v1")
     */
    String getPluginId();
